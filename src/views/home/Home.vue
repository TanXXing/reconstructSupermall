<template>
  <div id="home">
    ...
    <home-tab-control :tab-list="tabList" class="tabControl1" ref="tabControl1" v-show="isFixedTop"
      @tabItemClick="tabItemClick" />
    <scroll class="scroll-wrapper" ref="scroll" @scroll="scroll" @pullingUp="pullingUp" :probe-type="3"
      :pull-up-load="true" :click="true">
      <home-swiper :banner="banner"></home-swiper>
      <home-recommend :recommed="recommend"></home-recommend>
      <home-feature />
      <home-tab-control :tab-list="tabList" ref="tabControl2" @tabItemClick="tabItemClick" />
